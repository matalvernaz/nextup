...
def _series_hit(planned: dict, query: str) -> dict:
    ...
    return {
        ...
        # row is acted on; the title is what the catalogue calls it. They differ
        # whenever somebody typed a shorter name than Audible's, and the row has
        # to say which series ten books are about to come from.
        "itemKey": name,
